...
export const APPLICATION_STATUS_LABELS: Record<ApplicationStatus, string> = {
  DRAFT: 'Draft',
  SUBMITTED: 'Diajukan',
  ADMIN_REVIEW: 'Verifikasi Dokumen',
  ADMIN_REVISION_REQUIRED: 'Perbaikan Dokumen',
  DOCUMENT_COMPLETE: 'Dokumen Lengkap',
  WAITING_ASSIGNMENT: 'Siap Dijadwalkan',
  INSPECTION_SCHEDULED: 'Pemeriksaan Dijadwalkan',
  INSPECTION_IN_PROGRESS: 'Sedang Diperiksa',
  FIELD_REVISION_REQUIRED: 'Perbaikan Lapangan',
  WAITING_RESULT_VALIDATION: 'Validasi Hasil Pemeriksaan',
